...
class _TimerCircleState extends ConsumerState<TimerCircle> with SingleTickerProviderStateMixin {
  ...
  void _showCompletionFeedback() async {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('You completed your focus session.\n\n"$phrase"'),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    final totalMinutes = timerStats.fold(0, (sum, s) => sum + s.durationMinutes);
    return Column(
      ...
      children: [
              ...
              Padding(
                ...
                child: ChoiceChip(
                  ...
                  labelStyle: TextStyle(
                    color: _selectedDuration == d ? Colors.white : Colors.grey[800],
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(_isRunning ? 'Focusing...' : 'Ready', style: TextStyle(color: Colors.grey[600], fontSize: 18)),
              ],
            ),
          ],
        ),
        ...
        Text('Sessions: $totalSessions', style: TextStyle(color: Colors.grey[700], fontSize: 16)),
        Text('Total time: $totalMinutes min', style: TextStyle(color: Colors.grey[700], fontSize: 16)),
      ],
    );
  }
}
